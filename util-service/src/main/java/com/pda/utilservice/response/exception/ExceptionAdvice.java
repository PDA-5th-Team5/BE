package com.pda.utilservice.response.exception;
...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity onThrowException(GeneralException generalException, HttpServletRequest request) {
        ...
        return handleExceptionInternal(generalException, errorReasonDto, null, request);
    }
    ...
    private ResponseEntity<Object> handleExceptionInternalFalse(Exception e, ErrorStatus errorStatus,
        ...
        ApiResponse<Object> body = ApiResponse.onFailure(errorStatus.getStatus(), errorStatus.getMessage(), errorPoint);
        return super.handleExceptionInternal(
                e,
                body,
                headers,
    ...
    private ResponseEntity<Object> handleExceptionInternalArgs(Exception e, HttpHeaders headers, ErrorStatus errorStatus,
        ...
        ApiResponse<Object> body = ApiResponse.onFailure(errorStatus.getStatus(), errorStatus.getMessage(), errorArgs);
        return super.handleExceptionInternal(
                e,
                body,
                headers,
    ...
    private ResponseEntity<Object> handleExceptionInternalConstraint(Exception e, ErrorStatus errorStatus,
        ...
        ApiResponse<Object> body = ApiResponse.onFailure(errorStatus.getStatus(), errorStatus.getMessage(), null);
        return super.handleExceptionInternal(
                e,
                body,
                headers,
